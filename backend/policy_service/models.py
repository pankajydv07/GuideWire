...
from sqlalchemy import String, Integer, DateTime, ForeignKey, UniqueConstraint, ARRAY
...
class Policy(Base):
    ...
    slots_covered: Mapped[list | None] = mapped_column(ARRAY(String), nullable=True)
